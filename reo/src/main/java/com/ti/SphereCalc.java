...
public class SphereCalc {
    ...
    public double getMeasurementFullImp(double ro1, double ro2, double a, double b, double r, double h, double x, double y){
        setParam(ro1, ro2, a, b, r, h, x, y);
        double value = p.roTissue*2*p.b/(Math.PI*(p.a*p.a-p.b*p.b));
        value += getMeasurement();
        return value;
    }
    ...
    public double getMeasurement(double ro1, double ro2, double a, double b, double r, double h, double x, double y) {
        setParam(ro1, ro2, a, b, r, h, x, y);
        double value = potentialInPointFromElectrode(toA(), toM(),getCosinus(toM(),toA(), (p.a - p.b)));
        value -= potentialInPointFromElectrode(toA(), toN(),getCosinus(toN(),toA(), (p.a + p.b)));
        value += potentialInPointFromElectrode(toB(), toN(),getCosinus(toN(),toB(), (p.a - p.b)));
    ...
    public SphereCalc setParam(SphereModelParam p ){
        this.p = p;
        return this;
    }
    public SphereCalc setParam(double ro1, double ro2, double a, double b, double r, double h, double x, double y){
        p.setParam(ro1, ro2, a, b, r, h, x, y);
        return this;
    }

    private double potentialInPointFromElectrode(double toEl, double toPt, double cosElPt){
        double potentialValue;
        potentialValue = p.roTissue/(Math.PI*toEl)*summaPoN(100, toPt, toEl, cosElPt);
